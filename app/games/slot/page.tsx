...
export default function SlotMachine() {
  ...
  const spinSound = useRef(new Audio(SOUNDS.SPIN));
  const winSound = useRef(new Audio(SOUNDS.WIN));
  const reelStopSound = useRef(new Audio(SOUNDS.REEL_STOP));
  const coinSound = useRef(new Audio(SOUNDS.COIN));
  ...
  const calculateWinnings = (finalSymbols) => {
    // Get the actual symbols that landed
